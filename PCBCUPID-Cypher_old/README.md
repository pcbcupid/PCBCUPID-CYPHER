...
Designed for ESP32 (tested on Cypher V-2.0), this library lets you focus on your application instead of memorising pin numbers.
...
**Supported Board:**
- PCBCUPID Cypher V-2.0 (ESP32-S3-MINI-1)
...
Developed and maintained by **PCBCUPID**, based on the Cypher V-2.0 board design.
